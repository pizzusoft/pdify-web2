...
const PrivacyAndSecurity = () => {
    return (
        <div>
            Privacy Policy Effective date: May 26, 2024 Jad Joubran B.V. ("us",
            "we", or "our") operates the https://react-tutorial.app website (the
            ...
            Privacy Policy for Jad Joubran B.V. is based on the Free Privacy
            Policy Template Website. We use your data to provide and improve the
            ...
            from https://react-tutorial.app Information Collection And Use We
            collect several different types of information for various purposes
            to provide and improve our Service to you. Types of Data Collected
            ...
            information: GitHub id GitHub primary email address Github username
            Github avatar Github name (if available) Usage Data We may also
            collect information how the Service is accessed and used ("Usage
            Data"). This Usage Data may include information such as your browser
            ...
            device identifiers and other diagnostic data. However, we anonymize
            your Internet Protocol address. Tracking & Cookies Data We use
            anonymous cookies to make some parts of the website work. For
            example, we use cookies to remember your temporary progress in the
            course until it gets saved. We do not use cookies for tracking.
            ...
            some portions of our Service. Examples of Cookies we use: Session
            ...
            security purposes (Cloudflare, Stripe). Use of Data Jad Joubran B.V.
            uses the collected data for various purposes: To provide and
            ...
            analysis or valuable information so that we can improve the Service
            To monitor the usage of the Service To detect, prevent and address
            technical issues Transfer Of Data Your information, including
            Personal Data, may be transferred to — and maintained on — computers
            located outside of your state, province, country or other
            governmental jurisdiction where the data protection laws may differ
            than those from your jurisdiction. If you are located outside
            Netherlands and choose to provide information to us, please note
            that we transfer the data, including Personal Data, to Netherlands
            and process it there. Your consent to this Privacy Policy followed
            by your submission of such information represents your agreement to
            that transfer. Jad Joubran B.V. will take all steps reasonably
            ...
            and other personal information. Disclosure Of Data Legal
            Requirements Jad Joubran B.V. may disclose your Personal Data in the
            good faith belief that such action is necessary to: To comply with a
            legal obligation To protect and defend the rights or property of Jad
            Joubran B.V. To prevent or investigate possible wrongdoing in
            ...
            cannot guarantee its absolute security. Service Providers We may
            ...
            obligated not to disclose or use it for any other purpose. Analytics
            We use the open source Plausible Analytics to count website visits,
            browser vendors, device types, etc. No cookies are used and no
            personal data—not even an IP address or browser user agent—is
            stored. Plausible is GDPR and CCPA compliant. Links To Other Sites
